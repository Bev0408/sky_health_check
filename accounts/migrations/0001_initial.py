    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('engineer', 'Engineer'), ('team_leader', 'Team Leader'), ('department_leader', 'Department Leader'), ('senior_manager', 'Senior Manager'), ('admin', 'Administrator')], default='engineer', max_length=20)),
